...
<style>
.plugin-hero {
    background: linear-gradient(135deg, {{ $hero_color }} 0%, {{ $hero_color_dark }} 50%, {{ $hero_color_darker }} 100%);
    color: white;
    padding: 4rem 0;
    position: relative;
    overflow: hidden;
...
.feature-icon {
    width: 50px;
    height: 50px;
    background: linear-gradient(135deg, {{ $feature_color }}, {{ $feature_color_dark }});
    border-radius: 12px;
    display: flex;
    align-items: center;
    justify-content: center;
...
.benefit-item::after {
    ...
    width: 100%;
    height: 4px;
    background: linear-gradient(90deg, {{ $benefit_color }}, {{ $benefit_color_dark }});
    transform: scaleX(0);
...
.benefit-icon {
    width: 80px;
    height: 80px;
    background: linear-gradient(135deg, {{ $benefit_color }}15, {{ $benefit_color_dark }}15);
    border-radius: 20px;
    display: flex;
    align-items: center;
    justify-content: center;
    color: {{ $benefit_color_dark }};
    font-size: 2rem;
    margin: 0 auto 1.5rem;
    transition: all 0.3s ease;
    border: 1px solid {{ $benefit_color }}30;
}

.benefit-item:hover .benefit-icon {
    background: linear-gradient(135deg, {{ $benefit_color }}, {{ $benefit_color_dark }});
    color: white;
...
.cta-section {
    padding: 5rem 0;
    background: linear-gradient(135deg, {{ $hero_color }}, {{ $hero_color_dark }});
    color: white;
    text-align: center;
}
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="cta-buttons">
                        <a href="#" class="btn btn-plugin btn-primary-plugin buy-btn" data-plugin="{{ $plugin['slug'] }}" data-period="monthly">
...
<section class="features-section">
    <div class="container">
        <h2 class="section-title">Powerful {{ $plugin_category }} Features</h2>
...
<section class="cta-section">
    <div class="container">
        <h2 class="cta-title">Ready to {{ $cta_action }}?</h2>
        <p class="cta-description">Join thousands of satisfied customers who trust {{ $plugin['name'] }} for their {{ $plugin_category }} needs.</p>
            ...
            <div class="pricing-cards">
                <div class="pricing-card monthly-card active">
                    ...
                    <ul class="features-list">
                        <li><i class="fas fa-check"></i> All {{ $plugin_category }} features</li>
