            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Add New WordPress Plugin</h4>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('tested_up_to') is-invalid @enderror" 
                                                        id="tested_up_to" name="tested_up_to" value="{{ old('tested_up_to', '6.0') }}" required>
                                                    @error('tested_up_to')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('requires_php') is-invalid @enderror" 
                                                        id="requires_php" name="requires_php" value="{{ old('requires_php', '7.4') }}" required>
                                                    @error('requires_php')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('requires_wordpress') is-invalid @enderror" 
                                                        id="requires_wordpress" name="requires_wordpress" value="{{ old('requires_wordpress', '5.6') }}" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('changelog') is-invalid @enderror" 
                                                id="changelog" name="changelog" rows="4">{{ old('changelog') }}</textarea>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" step="0.01" min="0" class="form-control @error('price_monthly') is-invalid @enderror" 
                                                            id="price_monthly" name="price_monthly" value="{{ old('price_monthly', '9.99') }}" required>
                                                    </div>
                                                    @error('price_monthly')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" step="0.01" min="0" class="form-control @error('price_yearly') is-invalid @enderror" 
                                                            id="price_yearly" name="price_yearly" value="{{ old('price_yearly', '99.99') }}" required>
                                                    </div>
                                                    @error('price_yearly')
                                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" min="1" max="100" class="form-control @error('default_activation_limit') is-invalid @enderror" 
                                                            id="default_activation_limit" name="default_activation_limit" value="{{ old('default_activation_limit', '1') }}" required>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control @error('plugin_file') is-invalid @enderror" 
                                                id="plugin_file" name="plugin_file" accept=".zip" required>
                                            <div class="form-text">Upload the main plugin ZIP file (max 10MB).</div>
                                            @error('plugin_file')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <input type="url" class="form-control @error('support_url') is-invalid @enderror" 
                                                id="support_url" name="support_url" value="{{ old('support_url') }}">
                                            @error('support_url')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-save me-1"></i> Save Plugin
                                            </button>
                                        </div>
                                    </div>
                                </div>
